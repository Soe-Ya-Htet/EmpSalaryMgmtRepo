...
let CsvUploadComponent = class CsvUploadComponent {
    constructor(service) {
...
CsvUploadComponent.ctorParameters = () => [
...
let EmployeeService = class EmployeeService {
    ...
    getEmployees(minSalary, maxSalary, offset, limit, sort) {
        const url = `${this.baseUrl}/users`;
        let queryParams = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().append("minSalary", minSalary).append("maxSalary", maxSalary).append("offset", offset)
